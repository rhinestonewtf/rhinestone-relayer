...
export const recordBundleFill = (chainId: string, address: string, status: BundleActionStatus) => {
...
export const recordBundleClaim = (chainId: string, address: string, status: BundleActionStatus) => {
