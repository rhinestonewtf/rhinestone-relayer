export const sameChainAdapterAbi = [
  {
    type: 'constructor',
    inputs: [
      {
  ...
  {
    type: 'function',
    name: 'samechain_handleFill',
    inputs: [
      {
        name: 'fillData',
        type: 'tuple',
        internalType: 'struct SameChainAdapter.FillData',
        components: [
          {
            name: 'order',
            type: 'tuple',
  ...
  {
    type: 'function',
    name: 'samechain_handleFillWithFee',
    inputs: [
      {
        name: 'fillData',
        type: 'tuple',
  ...
  {
    type: 'function',
    name: 'samechain_handleFillWithFeeAndRefund',
    inputs: [
      {
        name: 'fillData',
        type: 'tuple',
      ...
      },
      {
        name: 'refund',
        type: 'tuple',
        internalType: 'struct AdapterBase.SolverRefund',
        components: [
          {
            name: 'permit',
            type: 'tuple',
